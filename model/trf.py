...
for ln in [SRC_LANGUAGE, TGT_LANGUAGE]:
    ...
    # train_iter = Multi30k(split='train', language_pair=(SRC_LANGUAGE, TGT_LANGUAGE), path = './Multi30k/multi30k/', langs = ['de','en'], exts =  ['train.en','train.de'],   fields=(DE, EN)) 
    train_iter = Multi30k(path = './Multi30k/multi30k/', exts =  ['train.en','train.de'],   fields=(DE, EN)) 
    print(train_iter)
