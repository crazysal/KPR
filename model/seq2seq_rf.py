...
class Transformer(nn.Module):
    ...
    def forward(self, src, trg):
        ...
        print('in trf fwd emb', embed_src.shape, embed_trg.shape)
        # print('src', embed_src)
...
print(src_pad_idx, '--pad ')
print(english.vocab.stoi["<sos>"], 'sra')
print(english.vocab.stoi["<eos>"], 'stop')
# exit()
...
for epoch in range(num_epochs):
    ...
    for batch_idx, batch in enumerate(train_iterator):
        ...
        # Forward prop
        # print('In fwd prop', inp_data.shape, target[:-1, :].shape)
        ...
        optimizer.zero_grad()
        print('loss op/tg:', output.shape, target.shape)     
        print('loss op/tg:', output)
        print('loss op/tg:', target)     
